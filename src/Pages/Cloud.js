    ...
    <div>
      ...
      <div className="pt-20">
        <div class="px-3 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10">
          <div class="grid grid-cols-1 lg:xl:grid-cols-3 md:grid-cols-2 group bg-white shadow-xl shadow-neutral-100 border ">
            {Data.map((post) => {
              return (
                <a
                  href={post.Drivelink}
                ...
                >
                  <div class="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                    ...
                    <p class="mt-2 text-sm text-slate-500">{post.content}</p>
                  </div>
                </a>
              );
            })}
          ...
          <div class="w-full   bg-indigo-600 shadow-xl shadow-indigo-200 md:py-10 py-5 md:px-20 px-5 flex justify-between items-center">
            <p class=" text-white">
              {" "}
