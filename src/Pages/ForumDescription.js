                ...
                <div className="container w-9/12 text-blue-700">
                  ...
                  <div className='border-2'>
                    ...
                    <div className='grid grid-cols-3'>
                      <div className='pl-2 mb-2'><span className='font-semibold'>Time</span>: 09:55 PM</div>
                      <div className='mb-2'><span className='font-semibold'>Date</span>: {item.date}</div>
                      <div className='pr-2 mb-2'><span className='font-semibold'>Venue</span>: Civil Department Hall G1</div>

                    </div>

                  </div>
                  <div id='loginToPostComment' style={{ transform: 'translate(66% ,0)', marginTop: '18px', display: 'flex' }} onClick={ShowComment} ><a href="/login" className='font-semibold border-2 px-5 py-1  bg-sky-200'>Login</a></div>
                  
                  <div id='Notice' style={{ display: 'inline' }}>
                  <button style={{cursor:'pointer',backgroundColor:'grey'}} onClick={ShowComment}>View Comment</button>
